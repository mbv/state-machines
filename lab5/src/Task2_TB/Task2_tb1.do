#  File: 'C:\POCP\lab5\lab5\src\Task2_TB\Task2_tb1.do'
...
comp "C:\POCP\lab5\lab5\src\Task2_TB\Task2_tb1.vhd"

#
# set top-level and initialize the simulator with Code Coverage Data
#
asim -cc -cc_dest $DSN/coverage/Task2_cc_tb1 -cc_hierarchy -cc_all Task2_cfg_tb1
...
run -all
endsim
write wave "C:\POCP\lab5\lab5\src\Task2_TB\Task2_tb1.awf"
#close -wave
